...
const sportsData = [
  ...
  // { id: 1, name: "Football", description: "Team sport played with a spherical ball", place: "Stadium A", rate:  500, image: "https://i.pinimg.com/736x/dd/74/e4/dd74e4cfc114acde909d20af9eab8c7a.jpg" },
  {
    id: 2,
    name: "Badminton",
    description: "Racquet sport played with a shuttlecock over a net",
    place: "Indoor Court B",
    rate: 300,
    image: "https://th.bing.com/th/id/OIG2.z0s6AaPWLxrYokm5YGtn?w=1024&h=1024&rs=1&pid=ImgDetMain",
  },
  ...
  { id: 7, name: "Cricket", description: "Bat-and-ball game played between two teams of eleven players each", place: "Ground G", rate: 8900, image: "https://th.bing.com/th/id/OIG2.l9LAoS22evkpPaeb5FH.?pid=ImgGn" },
  ...
  { id: 9, name: "Swimming", description: "Individual or team sport involving movement through water", place: "Pool I", rate: 2805, image: "https://th.bing.com/th/id/OIG1.DzNqtzJSwlO02h5HmxZJ?w=1024&h=1024&rs=1&pid=ImgDetMain" },
...
const PlayCards = () => {
  ...
  return (
    <div className="cards-container-wrapper  bg-blue-100 dark:bg-gray-800 pb-10 lg:pb-10">
